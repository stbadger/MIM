...
param($registryPath, $registryValueName, $registryValueData, $username)
    ...
    # Only conducts PCNS validation testing if the PCNS service registry path exists.
    if (Test-Path $registryPath) {
        ...
        Write-Host "There was an error finding the PCNS service registry path."
        Write-Output "There was an error finding the PCNS service registry path."
    }
